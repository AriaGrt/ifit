...
export default class GCV extends Component {
  render(){
    return(
      <div style={{padding: 40, textAlign: 'center'}}>
        <h3>Conditions générales de vente de prestations de services en ligne à des consommateurs particuliers</h3>
        <p style={{textAlign:'justify'}}>Préambule - Les présentes conditions générales de vente s'appliquent à toutes les prestations de services conclues sur le site Internet Ifit-Trainer.
          Le site Internet Ifit-Trainer est un service de :
          - la société Ifit Trainer
          - située à : 74 rue curial 7509 paris
          - adresse URL du site : www.ifit-trainer.fr
          - adresse mél : contact@ifit-trainer.fr
          - téléphone : 0668444701
        ...
        <p style={{textAlign:'justify'}}>Article 1 - Contenu et champ d'application
Les présentes conditions générales de vente s'appliquent de plein droit aux prestations de services suivantes : Cours particuliers de sport à domicile, en extérieur, en entreprise ou en club .
...
L'acheteur déclare avoir pris connaissance des présentes conditions générales de vente et les avoir acceptées avant son achat immédiat ou la passation de sa commande.
        ...
        <p>Article 2 - Informations précontractuelles
...
<p>
  ...
  Sauf conditions particulières expresses propres à la vente, l'exécution de la prestation s'effectuera dans le délai de 2 mois à compter de la réception par le vendeur d'une commande en bonne et due forme.
...
<p>Article 6- Exceptions au délai de rétractation
...
<p>Article 9 - Garanties - Généralités
Ifit Trainer est garant de la conformité des prestations au contrat.
L'acheteur peut formuler une demande au titre de la garantie légale de conformité prévue aux articles L. 217-11 et suivants du code de la consommation ou de la garantie des défauts de la chose vendue au sens des articles 1641 et suivants du code civil.
...
L'acheteur doit faire connaître au prestataire, les vices et/ou défauts de conformité dans un délai maximum de 24 mois à compter de la fourniture des services.
...
<p>Article 10 - Propriété intellectuelle
Tous les documents techniques, produits, dessins, photographies remis aux acheteurs demeurent la propriété exclusive de Ifit Trainer, seul titulaire des droits de propriété intellectuelle sur ces documents, et doivent lui être rendus à sa demande.
...
<p>Article 11 - Juridiction compétente
Tous les litiges auxquels les opérations d'achat et de vente conclues en application des présentes conditions générales de vente pourraient donner lieu, concernant tant leur validité, leur interprétation, leur exécution, leur résiliation, leurs conséquences et leurs suites et qui n'auraient pas pu être résolus à l'amiable entre le vendeur et le client, seront soumis aux tribunaux compétents dans les conditions de droit commun.
Pour la définition de la juridiction compétente, le vendeur élit domicile à 74 rue curial 7509 paris.
</p>
<p>Article 12 - Langue du contrat
Les présentes conditions générales de vente sont rédigées en langue française. Dans le cas où elles seraient traduites en une ou plusieurs langues étrangères, seul le texte français ferait foi en cas de litige.
</p>
<p>En cas de contestation, les coordonnées du médiateur auquel le consommateur peut s'adresser sont les suivantes: AME CONSO, 197, Boulevard Saint-Germain, 75007 Paris, .</p>
<p>Article 14 - Loi applicable
...
<p>Article 15 - Protection des données personnelles
Données collectées:
Les données à caractère personnel qui sont collectées sur ce site sont les suivantes :
Ouverture de compte: lors de la création du compte de l'utilisateur, ses nom, prénom, adresse électronique; n° de téléphone; adresse postale; état de santé, pathologie particulière liés à la pratique de l'activité sportive
...
En application de la réglementation applicable aux données à caractère personnel, les utilisateurs disposent des droits suivants, qu'ils peuvent exercer en faisant leur demande à l'adresse suivante: contact@ifit-trainer.fr.
...
<div style={{textAlign: 'center'}}>
  ...
  A l'attention de:
  Ifit Trainer,
  situé à 74 rue curial 7509 paris,
  n° de téléphone : 0668444701,
  adresse mél : contact@ifit-trainer.fr.
