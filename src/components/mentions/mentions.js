...
1.1 Site (ci-après « le site ») :  ifit-trainer

1.2 Éditeur (ci-après « l'éditeur ») :

Ifit Trainer SASU, au capital de  100€,
dont le siège social est situé: 74 rue curial, 75019 Paris
représentée par Ivan Beaufils, en sa qualité de Président,
immatriculée au RCS de Paris 82879759600011,
n° de téléphone : 07 69 51 36 34 ,
adresse mail : contact@ifit-trainer.fr

1.3 Hébergeur (ci-après « l'hébergeur ») :

ifit-trainer est hébergé par OVH, dont le siège social est situé 2 rue Kellermann ,  59100 Roubaix - France.
</p>
...
Vos données sont collectées par  La société Ifit Trainer.
...
Vous êtes susceptible de recevoir des offres commerciales de l'éditeur. Si vous ne le souhaitez pas, veuillez cliquer sur le lien suivant : info@ifit-trainer.fr
Vos données sont susceptibles d’être utilisées par les partenaires de l'éditeur à des fins de prospection commerciale, Si vous ne le souhaitez pas, veuillez cliquer sur le lien suivant : info@ifit-trainer.fr
